...
seo:
  title: "Charcole Project Structure | Folder & File Layout"
  description: Understand the folder structure and file organization of a Charcole project. Learn how JavaScript and TypeScript templates are organized.
  keywords:
    - charcole project structure
    - charcole folder layout
    - nodejs project structure
    - express project organization
    - charcole file structure
