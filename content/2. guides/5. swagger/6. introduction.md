...
description: Learn how @charcoles/swagger eliminates schema duplication and makes API documentation effortless.
navigation:
  icon: i-lucide-book-open
seo:
  title: "Charcole Swagger Documentation"
  description: Learn how @charcoles/swagger auto-generates OpenAPI documentation from Zod schemas with zero duplication.
  keywords:
    - charcole swagger
...
`@charcoles/swagger` is not fancy.
