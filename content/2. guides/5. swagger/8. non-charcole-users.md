...
description: How to use @charcole/swagger in any Express.js project, even if you didn't use create-charcole.
navigation:
  icon: i-lucide-package-plus
seo:
  title: "Use @charcole/swagger in Any Express Project"
  description: Install and configure @charcole/swagger in any existing Express.js application with Zod validation.
  keywords:
...
## Using @charcole/swagger without Charcole

One of the design goals of **@charcole/swagger** is that it works everywhere.

It is not locked to Charcole projects.
It does not require any Charcole CLI.
It does not depend on Charcole architecture.

If you have an Express.js project and you use Zod for validation, you can install @charcole/swagger and immediately eliminate schema duplication.
...
- `@charcole/swagger` for auto-generated documentation
...
3. Read the package README: `node_modules/@charcole/swagger/README.md`
...
@charcole/swagger is a standalone package.
