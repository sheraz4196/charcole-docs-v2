...
description: How to use @charcoles/swagger in any Express.js project, even if you didn't use create-charcole.
navigation:
  icon: i-lucide-package-plus
seo:
  title: "Use @charcoles/swagger in Any Express Project"
  description: Install and configure @charcoles/swagger in any existing Express.js application with Zod validation.
  keywords:
