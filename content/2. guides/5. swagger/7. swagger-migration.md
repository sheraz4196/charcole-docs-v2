...
seo:
  ...
  description: Step-by-step guide to add @charcolesswagger to existing Charcole v2.1 projects and eliminate schema duplication.
  keywords:
    - charcole migration
...
This guide shows how to add `@charcolesswagger` to your existing project and eliminate schema duplication.
...
Before adding `@charcolesswagger`, you either:
...
**Example - Before @charcolesswagger:**
...
```typescript
import { setupSwagger } from "@charcolesswagger";
import type { SwaggerOptions } from "@charcolesswagger";
...
Adding `@charcolesswagger` to an existing Charcole project is straightforward.
