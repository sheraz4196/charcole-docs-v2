...
description: Practical examples of using @charcole/swagger for common API patterns.
navigation:
  icon: i-lucide-code-2
seo:
  title: "Charcole Swagger Examples"
  description: Real-world examples of using @charcole/swagger for CRUD APIs, authentication, and protected routes.
  keywords:
...
The `bearerAuth` scheme is automatically configured by @charcole/swagger.
...
That is the entire point of @charcole/swagger.
