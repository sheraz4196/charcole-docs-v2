...
description: Practical examples of using @charcolesswagger for common API patterns.
navigation:
  icon: i-lucide-code-2
seo:
  title: "Charcole Swagger Examples"
  description: Real-world examples of using @charcolesswagger for CRUD APIs, authentication, and protected routes.
  keywords:
...
The `bearerAuth` scheme is automatically configured by @charcolesswagger.
...
That is the entire point of @charcolesswagger.
